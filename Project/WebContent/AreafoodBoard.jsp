...
// String keyWord = request.getParameter("keyWord");
	String areafood = request.getParameter("area");
	System.out.println(areafood+" : areafood 값 페이지");
	businessDao bdao = new businessDao();
			

   Vector list = bdao.getBusinessAreaList(areafood);
...
<form method="post" name="read" action="Read.jsp">
   ...
   <input type="hidden" name="page" value="AreafoodBoard.jsp" />
